...
Create a Scene detail
"I light the building on fire"
Player: Create a scene detail "Burning". Everything in the scene is on fire.

DM: All characters who end their turn in a "Burning zone" take 1 damage.
"I turn out the lights"
Player: Create a Scene detail "Darkness Calls." The scene has a detail of darkness.

DM: Character's cannot see unless another detail allows them to.
"I cause a landslide"
Player: Create a Scene detail "Landslide". The scene has difficult terrain.

DM: Characters must pass a DC 8 Athletics roll to leave this zone
